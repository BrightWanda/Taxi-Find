...
public class HomeFragment extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Button button = rootView.findViewById(R.id.findBtn);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                textView =  rootView.findViewById(R.id.txtDestination);

                if(!checkBox.isChecked())
                {
                    longitude = 0;
                    latitude = 0;
                    TextView txtView = rootView.findViewById(R.id.txtOrigin);
                ...
                call.enqueue(new Callback<ArrayList<Distance>>(){
                    ...
                    public void onResponse(Call<ArrayList<Distance>> call, Response<ArrayList<Distance>> response) {
                        ...
                        if(distance != null && distance.size() != 0) {
                            ...
                            args.putString("destination", "Johannesburg");
                            RankListFragment nextFrag= new RankListFragment();
